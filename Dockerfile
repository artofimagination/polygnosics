...
RUN git clone -b issue_2_minimum_unit_test_coverage_for_products https://github.com/artofimagination/mysql-user-db-go-interface /tmp/mysql-user-db-go-interface && \
